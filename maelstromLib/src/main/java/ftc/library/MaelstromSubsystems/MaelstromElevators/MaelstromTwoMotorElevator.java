...
public class MaelstromTwoMotorElevator implements TimeConstants {
    ...
    public MaelstromTwoMotorElevator(String name1, String name2, MotorModel model, HardwareMap hwMap){
    ...
    public MaelstromTwoMotorElevator(String name1, String name2, MotorModel model, DcMotorSimple.Direction direction1, DcMotorSimple.Direction direction2, HardwareMap hwMap){
